...
def EDGE(X,Y,U=10, gamma=[1, 1], epsilon=[0,0], epsilon_vector = 'range', eps_range_factor=0.1, normalize_epsilon = False ,
				ensemble_estimation = 'median', L_ensemble=1 ,hashing='p-stable', stochastic = True):
